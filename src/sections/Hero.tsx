  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ translateY: "-50%", translateX: "-50%" }}
        className="absolute h-[444px] w-[444px] md:w-[780px] md:h-[780px] rounded-full border border-white/20 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 border-dashed"
      ></motion.div>
      {/* End Ring 2 */}
      {/* Start Ring 3 */}
      <motion.div
        ...
        style={{ translateY: "-50%", translateX: "-50%" }}
        className="absolute h-[544px] w-[544px] md:w-[980px] md:h-[980px] rounded-full opacity-20 border border-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
      >
        <div className="absolute h-2 w-2 left-0 bg-white rounded-full top-1/2  -translate-x-1/2 -translate-y-1/2"></div>
