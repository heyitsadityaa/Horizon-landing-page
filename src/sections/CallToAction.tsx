  ...
  return (
    <section className="py-20 md:py-24" ref={sectionRef}>
      <div className="container">
        ...
        >
          <div
            className="absolute inset-0 bg-[rgb(74,32,138)] bg-blend-overlay [mask-image:radial-gradient(50%_50%_at_35%,black,transparent)] group-hover:opacity-0 transition duration-700"
